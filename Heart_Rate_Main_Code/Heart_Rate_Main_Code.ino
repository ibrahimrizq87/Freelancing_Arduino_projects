...
void loop()
{
 ...
 Serial.print("sensor value: ");Serial.println(sensorValue);
  ...
  if (currentMillis - previousMillis >= interval)
  {
   ...
   String path =  GenTxt();
     Firebase.setInt(firebaseDataObject, "/Heart Rate/Now/Heart Rate is", heartRate);
    if(heartRate > 83 && heartRate< 140){
    Firebase.setString(firebaseDataObject, "/Heart Rate/Now/condition", "normal");
        ...
        Firebase.setString(firebaseDataObject, "/Heart Rate/Alert/LOW/"+path+"/value",heartRate );
        ...
        Firebase.setString(firebaseDataObject, "/Heart Rate/Alert/HIGH/"+path+"/value",heartRate );
